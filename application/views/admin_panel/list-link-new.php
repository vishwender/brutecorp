            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                  ...
                  <?php foreach($links as $key => $list){  ?>
                        <tr>
                            <td><?php echo $list['link_keyword'] ?></td>
                            <td><?php echo $list['link_url'] ?></td>
                            <td><?php echo anchor('admins/services/edit_link/'. $list['link_id'],'Edit') . ' '. anchor('admins/services/delete/'. $list['link_id'],'Delete','class="delete" title="'. $list['link_keyword'] .'"'); ?></td>
                        </tr>
                 <?php } ?>
                    </tbody>
                    </table>
