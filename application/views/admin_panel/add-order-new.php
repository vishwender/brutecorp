                        ...
                        <div class="ibox-content">
                            <?php echo form_open_multipart('','role="form"') ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('category',$data,set_value('category', isset($list['order_category_id']) ? $list['order_category_id'] : ''),'class="form-control"') ?>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Order Franchise</label>
                                            <?php 
                                            $data=array('1'=>'administrator');
                                            foreach($franchise as $key => $list2){
                                                $data[$list2['user_id']]=$list2['user_username'];
                                            }
                                            echo form_dropdown('franchise',$data,set_value('category', isset($list['order_franchise_id']) ? $list['order_franchise_id'] : ''),'class="form-control"') ?>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('user',$data,set_value('user', isset($list['order_user_id']) ? $list['order_user_id'] : ''),'class="form-control"') ?>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Price</label>
                                            <?php echo form_input(array('name'=>'price','id'=>'price','value'=>set_value('price', isset($list['order_price']) ? $list['order_price'] : ''),'class'=>'form-control')) ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
                                            <?php 
                                            echo form_dropdown('status',array('inactive'=>'Inactive','active'=>'Active'),set_value('status', isset($list['order_status']) ? $list['order_status'] : ''),'class="form-control"') ?>
                                        </div>
