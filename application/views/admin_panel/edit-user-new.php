...
?>
                        ...
                        <div class="ibox-content">
                            <?php echo form_open_multipart('','role="form"') ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input(array('name'=>'dob','id'=>'datepicker','value'=>set_value('pin',isset($list['user_dob']) ? $list['user_dob'] : ''),'class'=>'form-control')) ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Username</label>
                                            <?php echo form_input(array('name'=>'username','id'=>'username','value'=>set_value('username', isset($list['user_username']) ? $list['user_username'] : ''),'class'=>'form-control','rows'=>2)) ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <?php echo form_password(array('name'=>'password','id'=>'password','value'=>set_value('password'),'class'=>'form-control','rows'=>2)) ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
                                            <?php echo form_dropdown('status',array('inactive'=>'Inactive','active'=>'Active'),set_value('status', isset($list['user_status']) ? $list['user_status'] : ''),'class="form-control"') ?>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="col-lg-6">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <img alt="image" class="img-responsive" src="<?php echo base_url()?>resources/uploads/<?php if(!empty($list['user_image'])){ echo $list['user_image'];}else{echo 'dummy-profile-pic.png';}?>">
                        </div>
                    </div>
                </div>
            </div>
