        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <?php foreach($reviews as $key => $list){ ?>
                                    
                    <tr class="odd gradeX">
                        <td><?php echo $this->back_model->select_field_where_db('bc_sv_category',array('category_id = '.$list['review_service_id']),'category_name'); ?></td>
                        <td><?php echo $list['review_uname'] ?></td>
                        <td><?php echo $list['review_uemail'] ?></td>
                        <td><?php echo $list['review_ucomment'] ?></td>
                        <td><?php echo anchor('admins/services/edit_review/'. $list['review_id'],'Edit') . ' '. anchor('admins/services/delete_review/'. $list['review_id'],'Delete','class="delete" title="'. aw_word_limiter($list['review_ucomment'],10) .'"'); ?></td>
                    </tr>
                    <?php } ?>
